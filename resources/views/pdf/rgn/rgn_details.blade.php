                ...
                <td width="30%">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="info-value1">{{ $rgns->rgn_no ?? 'N/A' }}</td>
                        </tr>
                        <tr>
                            <td class="info-label1">Bol No:</td>
                            <td class="info-value1">{{ $rgns->bol_no ?? 'N/A' }}</td>
                        </tr>
                        <tr>
                            <td class="info-label1">Shipping Company:</td>
                            <td class="info-value1">{{ $rgns->shipping_company ?? 'N/A' }}</td>
                        </tr>
                      
                        <tr>
                            <td class="info-label1">Returned by:</td>
                            @php
                                $employee = $rgns->returned_by ? \App\Models\Employee::find($rgns->returned_by) : null;
                            @endphp
                            <td class="info-value1">
                                {{ $employee ? ($employee->first_name . ' ' . $employee->middle_name . ' ' . $employee->last_name .' ('.$rgns->returned_by .')'  ?? 'N/A') : 'N/A' }}
                            </td>
     ...
     <br>
        ...
        <table class="products-table">
            ...
            @php
                $totalAmount = 0; 
            @endphp
            @foreach ($rgns->rgnItemDetails as $receiving_detail)
            <tr>
